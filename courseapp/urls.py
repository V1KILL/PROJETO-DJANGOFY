...
from .views import Home, Perfil, ViewRenderModule, ViewRenderVideo, CreateCheckoutSessionView, CancelView, SuccessView, ViewLogin, ViewRegister, ViewLogout, ViewLike, ViewCheck, ViewComentar, ViewResponder, ViewCreateVideo, ViewCreateTopicAndModule
urlpatterns = [
    path('', Home, name='home'),
